...
tests = [ {'description': 'PINA: 0x0A, PINB: 0x0A, PINC: 0x0A(10kg) => PORTD: 0x1E',
    'steps': [ {'inputs': [('PINA',0x0A)], 'iterations': 5 },
    	       {'inputs': [('PINB',0x0A)], 'iterations': 5 },
               {'inputs': [('PINC',0x0A)], 'iterations': 5 }, ],
    'expected': [('PORTD',0x1E)],
    },
    {'description': 'PINA: 0x0A(10kg), PINB: 0x0A, PINC: 0x64(100kg) => PORTD: 0xF2',
    'steps': [ {'inputs': [('PINA',0x0A)], 'iterations': 5 }, 
               {'inputs': [('PINB',0x0A)], 'iterations': 5 }, 
               {'inputs': [('PINC',0x64)], 'iterations': 5 }, ],
    'expected': [('PORTD',0xF2)],
    },
    {'description': 'PINA: 0x32, PINB: 0x32, PINC: 0x32(50kg) => PORTD: 0x97',
