...
tests = [ {'description': 'PINA: 0x64,(100kg) PINB: 0x50,(80kg) PINC: 0x0A(10kg) => PORTD: 0xBF',
    'steps': [ {'inputs': [('PINA',0x64)], 'iterations': 5 },
    	       {'inputs': [('PINB',0x50)], 'iterations': 5 },
               {'inputs': [('PINC',0x0A)], 'iterations': 5 }, ],
    'expected': [('PORTD',0xBF)],
    },
    {'description': 'PINA: 0x4F(79kg), PINB: 0x00, PINC: 0x00 => PORTD: 0x4C',
    'steps': [ {'inputs': [('PINA',0x4F)], 'iterations': 5 }, 
               {'inputs': [('PINB',0x00)], 'iterations': 5 }, 
               {'inputs': [('PINC',0x00)], 'iterations': 5 }, ],
    'expected': [('PORTD',0x4C)],
    },
    {'description': 'PINA: 0x32, PINB: 0x32, PINC: 0x64(100kg) => PORTD: 0xC9',
    'steps': [ {'inputs': [('PINA',0x32)], 'iterations': 5 }, 
               {'inputs': [('PINB',0x32)], 'iterations': 5 }, 
               {'inputs': [('PINC',0x64)], 'iterations': 5 }, ],
    'expected': [('PORTD',0xC9)],
    },
    {'description': 'PINA: 0x0A,(10kg) PINB: 0x32, PINC: 0x64(100kg) => PORTD: 0xA3',
