...
tests = [ {'description': 'PINA: 0x40,(64kg) PINB: 0x40,(64kg) PINC: 0x40(64kg) => PORTD: 0x31',
    'steps': [ {'inputs': [('PINA',0x40)], 'iterations': 5 },
    	       {'inputs': [('PINB',0x40)], 'iterations': 5 },
               {'inputs': [('PINC',0x40)], 'iterations': 5 }, ],
    'expected': [('PORTD',0x31)],
    },
    {'description': 'PINA: 0x00(0kg), PINB: 0x23,(35kg) PINC: 0x55(85kg) => PORTD: 0x1E',
    'steps': [ {'inputs': [('PINA',0x0)], 'iterations': 5 }, 
               {'inputs': [('PINB',0x23)], 'iterations': 5 }, 
               {'inputs': [('PINC',0x55)], 'iterations': 5 }, ],
    'expected': [('PORTD',0x1E)],
    },
    {'description': 'PINA: 0x00, PINB: 0x38,(56kg) PINC: 0x55(85kg) => PORTD: 0x22',
